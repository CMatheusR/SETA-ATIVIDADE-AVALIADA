        ...
        @foreach ($data as $item)
            <tr style="text-align: center">
                ...
                <td>
                    ...
                    @if($tipo ==2)
                        <a nohref style="cursor:pointer" onclick="peso('{{$item->id}}')"><img class="small" src="{{ asset('img/icons/peso.svg') }}"></a>
                        <a nohref style="cursor:pointer" onclick="conceito('{{$item->id}}')"><img class="small" src="{{ asset('img/icons/conceito.svg') }}"></a>
                    @endif
